                    ...
                    <div className="col mb-5">
                        <div className="card shadow rounded text-center">
                            ...
                            <div className="card-body govCardBody">
                                ...
                                <a href="https://contact.governor.alabama.gov/contact.aspx" className="govEmail btn btn-outline-danger mr-1">Email</a>
                                <a href="https://governor.alabama.gov/" className="govEmail btn btn-outline-danger">Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="card shadow rounded text-center">
                            ...
                            <div className="card-body govCardBody">
                               ...
                               <a href="https://www.alabamaag.gov/generalcontact" className="govEmail btn btn-outline-danger mr-1">Email</a>
                               <a href="https://www.alabamaag.gov/about" className="govEmail btn btn-outline-danger">Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="card shadow rounded text-center">
                            ...
                            <h5 className="card-title">John H. Merrill</h5>
                               ...
                               <a href="mailto:John.Merrill@sos.alabama.gov" className="govEmail btn btn-outline-danger mr-1">Email</a>
                               <a href="https://www.sos.alabama.gov/" className="govEmail btn btn-outline-danger">Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="card shadow rounded text-center">
                            ...
                            <div className="card-body govCardBody">
                               ...
                               <a href="mailto:ltgov@ltgov.alabama.gov" className="govEmail btn btn-outline-danger mr-1">Email </a>
                               <a href="https://ltgov.alabama.gov/" className="govEmail btn btn-outline-danger">Website</a>
                            </div>
                        </div>
                    </div>
