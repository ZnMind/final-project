...
const StateReps3 = () => {
  ...
  useEffect(() => {
    fetch(
      "https://v3.openstates.org/people?jurisdiction=Alabama&org_classification=lower&page=2&per_page=50&apikey=3e1fb642-5ba7-482c-ab7b-6a42d2db4bb6",
      {}
    )
...
<button id="staterepsbuttonbottom2" onClick={buttonClickBack}>
            Prev Page
          </button>
