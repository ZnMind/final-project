                            ...
                            <div className="col-sm-3 ">
                                <div className="card shadow rounded text-center mb-2">
                                    ...
                                    <div className="card-body cardBodyUsSenators">
                                        ...
                                        <a href="https://www.shelby.senate.gov/public/index.cfm/emailsenatorshelby" className="btn btn-outline-danger mr-1">Email</a>
                                        <a href="https://www.shelby.senate.gov/public/" className="govEmail btn btn-outline-danger">Website</a>
                                ...
                                <div className="card shadow rounded text-center mb-2">
                                    ...
                                    <div className="card-body cardBodyUsSenators">
                                        ...
                                        <p className="">Mailing Address:<small> 40 Dirksen Senate Office Building
                                            Washington,DC 20510</small></p>
                                        <a href="https://www.tuberville.senate.gov/contact/contact-form/" className="btn btn-outline-danger mr-1">Email</a>
                                        <a href="https://www.tuberville.senate.gov/" className="govEmail btn btn-outline-danger">Website</a>
                                    </div>
                                </div>
                            </div>
