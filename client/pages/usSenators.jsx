...
import "../components/images/usSenators.css"
                                ...
                                <div className="col-sm-3 ">
                                    <div className="card shadow rounded text-center ">
                                        ...
                                        <div className="card-body bodyUsSenators">
                                            ...
                                            <p className="mt-1">Mailing Address: 304 Russell Senate Office Building
                                ...
                                <div className="col-sm-3">
                                    <div className="card shadow rounded text-center">
                                        ...
                                        <div className="card-body bodyUsSenators">
                                            ...
                                            <p className="mt-1">Mailing Address: B40A Dirksen Senate Office Building
                                                Washington DC 20510</p>
